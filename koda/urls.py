...
urlpatterns = [
    ...
    path('blog-detay/(?P<id>[\w-]+)/$', views.blog_detail, name='blog_detail'),
    ...
    path('yolculukvar/', views.yolculuk_var, name='yolculuk_var'),
    path('aile-calismalari/', views.aile_calismalari, name='aile_calismalari'),
    path('okul-sonrasi-calismalari/', views.okul_sonrasi_calismalari, name='okul_sonrasi_calismalari'),
    path('koda-gonullusu/', views.koda_gonullusu, name='koda_gonullusu'),
    path('ogretmenim-agin-parcasi-olmak-istiyorum/', views.ogretmen_agin_parcasi, name='ogretmen_agin_parcasi'),
    path('ogretmenim-agin-parcasi-olmak-istiyorum/', views.egitmen_agin_parcasi, name='egitmen_agin_parcasi'),
